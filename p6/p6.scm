...
(define (odds lis)
  (cond
    ...
    ;base case
    ( (null? lis) '())
    ;single element case - return remaining element
    ( (null? (cdr lis)) lis)
    (else
...
(define (evens lis)
  (cond
    ;base case
    ( (null? lis) '())
    ;single element case - return empty list 
    ( (null? (cdr lis)) '())
    (else
...
(define (evenrev lis)
  (cond
    ...
    (else
     (revlist (evens lis))))) ;call helper functions to extract the evens then reverse
...
(define (penultimate lis)
  (cond
    ...
    ;empty list or single element - return empty list
    ( (or (null? lis) (null? (cdr lis))) '())
    ;base case - two elements remaining, return the first element
...
(define (palindrome lis)
  (cond
    ...
    ;empty list or single element - return true
    ( (or (null? lis) (null? (cdr lis))) #t)
    ;compare first and last elements
    ( (not (equal? (car lis) (car (revlist lis)))) #f)
    (else
     (palindrome (cdr (revlist (cdr lis)))))))  ;remove first and last elements of list
